	...
	<div class="table-responsive">
		...
		<?php if($hide=="lebih"):?>
			<div style='float: left;'>
				<button class='uibutton special btn btn-success btn-rounded' id='showData'>Selengkapnya...</button>
			</div>
		<?php endif;?>
		<div style="float: right;">
			<button id='tampilkan' onclick="toggle_tampilkan();" class="uibutton special btn btn-primary btn-rounded">Tampilkan Nol</button>
		</div>
	</div>
</div>
